    ...
    emitExpression(exp: Expression, toplevel: boolean): string {
        switch (exp.tag) {
            ...
            case ExpressionTag.SqlConnectExpression: {
                return this.emitSqlConnectExpression(exp as SqlConnectExpression, toplevel);
            }
